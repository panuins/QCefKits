...
win32: LIBS += d3d11.lib glu32.lib imm32.lib opengl32.lib oleacc.lib comctl32.lib rpcrt4.lib shlwapi.lib ws2_32.lib user32.lib Shell32.lib Gdi32.lib Comdlg32.lib gdi32.lib
...
else:LIBS += -L$$CEFPATH/Release -lcef -lpthread
